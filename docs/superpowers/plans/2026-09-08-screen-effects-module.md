...
The foundation gate was reverified on 2026-09-13 against `f2bb518692121eaa9b6f4230a250176bab9a766f`: both prerequisite changes are archived and synced, and their packaged acceptance records are present. Migration `022-screen-effects.ts` is therefore the next planned schema migration.
