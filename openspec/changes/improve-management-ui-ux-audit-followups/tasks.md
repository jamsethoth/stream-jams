...
- [ ] 10.1 Add failing foundation tests for four-second positive/info expiry, eight-second failure expiry, manual dismissal, accessible roles, and contained long error metadata.
