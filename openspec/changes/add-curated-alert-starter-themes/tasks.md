...
- [ ] 1.2 Add parsed alert-create input support that defaults omitted `themeId` to Clean Signal and rejects unknown IDs without mutation.
...
- [ ] 2.1 Thread parsed selected/default theme IDs through alert creation and lazy/default editor-document paths while keeping handlers thin.
...
- [ ] 3.2 Create shared read-only landscape and vertical theme previews that resolve event sample text and reuse the validated materialized output.
