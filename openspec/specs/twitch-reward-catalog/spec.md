# twitch-reward-catalog

## Purpose

Define secure, on-demand access to the linked Twitch broadcaster's custom reward catalog for stable-ID alert authoring without persisting provider metadata or exposing credentials.
