# Multi-Module Playback Operations Specification

## Purpose

Define merged Operator views, module-qualified commands, shared safety state, and occurrence-scoped media ownership without merging independent module schedulers.
